...
<head>
  <title>WebFlix-
    ...
    $show_id = $_GET['id'];
    $qtitle = "SELECT title from webflix_series WHERE series_id = $show_id";
  ...
  <script type="text/javascript" src="js/webflix_show_page_handler.js"></script>
...
<body style="overflow: hidden;">
  ...
  <div class="container" style="max-width: 1440px; position: relative;">
    ...
    <section class="vid-section">
      ...
      <div class="movie-container container show-controls">
        <div class="placeholder-info">
          ...
          <p style="font-size: 10px;">Tears of Steel was realized with crowd-funding by users of the open source 3D
    ...
    <?php include('includes/webflix_show_data.php'); ?>
  </div>
